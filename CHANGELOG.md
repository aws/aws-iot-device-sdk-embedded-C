...
### Major Changes
- This release introduces the **[AWS IoT Fleet Provisioning](https://github.com/aws/fleet-provisioning-for-aws-iot-embedded-sdk)** library and **[AWS SigV4](https://github.com/aws/SigV4-for-AWS-IoT-embedded-sdk)** library.
...
- [#1680](https://github.com/aws/aws-iot-device-sdk-embedded-C/pull/1670) Add new transport interface implementation using **MbedTLS** (for TLS stack) and **corePKCS11** (for credential management).
