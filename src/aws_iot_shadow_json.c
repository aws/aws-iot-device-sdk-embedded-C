...
/*helper functions */
static IoT_Error_t convertDataToString( char * pStringBuffer,
                                        size_t maxSizoStringBuffer,
...
static IoT_Error_t emptyJsonWithClientToken( char * pBuffer,
                                             size_t bufferSize )
{
...
IoT_Error_t aws_iot_shadow_internal_get_request_json( char * pBuffer,
                                                      size_t bufferSize )
{
    return emptyJsonWithClientToken( pBuffer, bufferSize );
}

IoT_Error_t aws_iot_shadow_internal_delete_request_json( char * pBuffer,
                                                         size_t bufferSize )
{
    return emptyJsonWithClientToken( pBuffer, bufferSize );
}

static inline IoT_Error_t checkReturnValueOfSnPrintf( int32_t snPrintfReturn,
...
static IoT_Error_t UpdateValueIfNoObject( const char * pJsonString,
