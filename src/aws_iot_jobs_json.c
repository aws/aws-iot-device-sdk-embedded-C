...
static void _printToBuffer( struct _SerializeState * state,
                            const char * fmt,
                            ... )
{
    if( state->totalSize == -1 )
    {
        return;
    }
...
static void _printKey( struct _SerializeState * state,
                       bool first,
                       const char * key )
{
    if( first )
...
static void _printStringValue( struct _SerializeState * state,
                               const char * value )
{
    if( value == NULL )
    {
...
static void _printLongValue( struct _SerializeState * state,
                             int64_t value )
{
    _printToBuffer( state, "%lld", value );
}

static void _printBooleanValue( struct _SerializeState * state,
                                bool value )
{
    if( value )
    {
