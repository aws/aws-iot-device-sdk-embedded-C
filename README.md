...
- [AWS IoT Device SDK for Embedded C](#aws-iot-device-sdk-for-embedded-c)
  ...
  - [Overview](#overview)
    ...
    - [Features](#features)
      ...
      - [AWS IoT Over-the-air Update](#aws-iot-over-the-air-update)
      - [AWS IoT Fleet Provisioning](#aws-iot-fleet-provisioning)
      - [AWS SigV4](#aws-sigv4)
  ...
  - [Branches](#branches)
    ...
    - [v4\_beta\_deprecated branch (formerly named v4\_beta)](#v4_beta_deprecated-branch-formerly-named-v4_beta)
  - [Getting Started](#getting-started)
    ...
    - [Configuring Demos](#configuring-demos)
      ...
      - [Configure S3 Download HTTP Demo using SigV4 Library:](#configure-s3-download-http-demo-using-sigv4-library)
