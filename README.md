...
You can generate the presigned urls using [demos/http/common/src/presigned_urls_gen.py](common/src/presigned_urls_gen.py). More info can be found [here](common/src/README.md).
