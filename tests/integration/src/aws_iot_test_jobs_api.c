 ...
 */
    ...
    void iot_next_job_callback_handler( AWS_IoT_Client * pClient,
                                        char * topicName,
                                        uint16_t topicNameLen,
                                        IoT_Publish_Message_Params * params,
                                        void * pData )
...
#endif /* ifndef DISABLE_IOT_JOBS_INTERFACE */
#endif /* ifndef DISABLE_IOT_JOBS */
