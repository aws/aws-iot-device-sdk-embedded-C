...
static size_t iot_tls_mqtt_read_variable_length_int( const unsigned char * buffer,
                                                     size_t startPos )
{
    size_t result = 0;
    size_t pos = startPos;
...
static size_t iot_tls_mqtt_get_end_of_variable_length_int( const unsigned char * buffer,
                                                           size_t startPos )
{
    size_t pos = startPos;

    while( ( buffer[ pos ] & 0x80 ) && pos - startPos < 3 )
    {
        pos++;
    }
...
static uint16_t iot_tls_mqtt_get_fixed_uint16_from_message( const unsigned char * msgBuffer,
                                                            size_t startPos )
{
...
static uint16_t iot_tls_mqtt_copy_string_from_message( char * dest,
