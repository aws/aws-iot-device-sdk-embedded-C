...
static int generateTopicForTestThingAndJob( char * buffer,
                                            size_t bufferSize,
...
static int generateTopicForTestThing( char * buffer,
                                      size_t bufferSize,
                                      AwsIotJobExecutionTopicType topicType,
                                      AwsIotJobExecutionTopicReplyType replyType )
{
...
static void testGenerateValidApiTopic( AwsIotJobExecutionTopicType topicType,
                                       AwsIotJobExecutionTopicReplyType replyType,
                                       bool includeThingName,
...
static void testGenerateValidApiTopicWithAllReplyTypes( AwsIotJobExecutionTopicType topicType,
                                                        bool includeThingName,
