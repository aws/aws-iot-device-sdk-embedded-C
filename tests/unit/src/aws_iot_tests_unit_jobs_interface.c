...
static void testCallback( AWS_IoT_Client * pClient,
                          char * topicName,
...
static void publishTestMessage( AwsIotJobExecutionTopicType topicType,
                                bool withJobId )
{
...
static void testSubscribeAndUnsubscribe( AwsIotJobExecutionTopicType topicType,
                                         bool withJobId )
{
...
static void testSendQuery( bool withJobId,
                           bool withClientToken,
